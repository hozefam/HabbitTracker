...
@Component({
  ...
  template: `
    <aside
      ...
      class="bg-gray-900 text-white transition-all duration-300 ease-in-out flex flex-col h-full"
    >
      <!-- Sidebar Header -->
      <div
      ...
      <nav class="flex-1 p-4 space-y-2">
        <a
          ...
          class="flex items-center p-3 rounded hover:bg-gray-800 transition-colors"
